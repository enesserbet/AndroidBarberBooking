...
public class RezActivity extends AppCompatActivity {

    private ActivityRezBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityRezBinding.inflate(getLayoutInflater());
        ...
        binding.processBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(RezActivity.this, ProcessActivity.class);
        ...
        binding.hoursBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(RezActivity.this, HoursActivity.class);
                startActivity(intent);
            }
        });
        ...
        ref.child("id")
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(RezActivity.this, "Workshop info updated...", Toast.LENGTH_SHORT).show();
                        abc();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(RezActivity.this, "" + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
        ...
        ref.child("" + timestamp)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(RezActivity.this, "Hour added successfully...", Toast.LENGTH_SHORT).show();
    ...
    private void loadPersonName() {
        ...
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Personnel");
