...
import com.example.androidbarberbooking.databinding.ActivityRezUser2Binding;
...
public class RezActivityUser2 extends AppCompatActivity {

    private ActivityRezUser2Binding binding;

    private FirebaseAuth firebaseAuth;

    private ProgressDialog progressDialog;

    private ArrayList<String> personnelNameArrayList2;
    private ArrayList<String> personnelIdArrayList2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityRezUser2Binding.inflate(getLayoutInflater());
        ...
        ref.child("" + timestamp)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(RezActivityUser2.this, "Workshop info updated...", Toast.LENGTH_SHORT).show();
                        abc();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(RezActivityUser2.this, "" + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    private void abc() {
        ...
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Reservation/GamzeKadinKuaforu");
        ref.child("" + timestamp)
                .setValue(hashMap)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void unused) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(RezActivityUser2.this, "Hour added successfully...", Toast.LENGTH_SHORT).show();
    ...
    private void loadPersonName() {
        Log.d(TAG, "loadPdfCategories: Loading personnel name");
        personnelNameArrayList2 = new ArrayList<String>();
        personnelIdArrayList2 = new ArrayList<String>();
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                personnelNameArrayList2.clear();
                personnelIdArrayList2.clear();
                for (DataSnapshot ds : snapshot.getChildren()) {
                    String personnelId = "" + ds.child("id").getValue();
                    String personnelName = "" + ds.child("title").getValue();

                    //add to respective arrayLists
                    personnelNameArrayList2.add(personnelName);
                    personnelIdArrayList2.add(personnelId);
                }
            }
    ...
    private void personnelPickDialog() {
        ...
        String[] categoriesArray = new String[personnelNameArrayList2.size()];
        for (int i = 0; i < personnelNameArrayList2.size(); i++) {
            categoriesArray[i] = personnelNameArrayList2.get(i);
        }
        ...
        builder.setTitle("Pick Category")
                .setItems(categoriesArray, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        selectedCategoryTitle = personnelNameArrayList2.get(which);
                        selectedCategoryId = personnelNameArrayList2.get(which);
